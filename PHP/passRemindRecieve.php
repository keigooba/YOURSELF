...
EOT;
                        ...
                        debug('新しいパスワードの中身：'.$pass);

                        return header("Location:login.php"); //ログインページへ
        ...
        <section id="main">
            ...
            <div class="form-container">
                ...
                <form action="" method="post" class="form">
                    <p>ご指定のメールアドレスにお送りした「認証キー」をご入力ください。</p>
                    <p>メールアドレスに新しいパスワードをお送り致します。</p>
                    <div class="area-msg">
